...
class PelamarController {
    ...
    public function store(array $data, array $files): void {
        ...
        $stmt->execute([
            ...
            ':bersedia'       => self::validateEnum($data['bersedia_seluruh_wilayah'] ?? 'Ya', ['Ya','Tidak']) ?? 'Ya',
            ...
            ':sim'            => $sim,
            ':k_marketing'    => self::validateEnum($data['khusus_pengalaman_marketing'] ?? '', ['Ya','Tidak']),
            ':k_relasi'       => self::validateEnum($data['khusus_relasi_bisnis'] ?? '', ['Ya','Tidak']),
            ':k_target'       => self::validateEnum($data['khusus_bersedia_target'] ?? '', ['Ya','Tidak']),
            ':k_kendaraan'    => self::validateEnum($data['khusus_kendaraan_pribadi'] ?? '', ['Ya','Tidak']),
            ':k_it_bidang'    => $khususItBidang,
            ':k_it_lang'      => $data['khusus_it_bahasa_pemrograman'] ?? null,
            ':k_lapkeu'       => self::validateEnum($data['khusus_analis_lapkeu'] ?? '', ['Ya','Tidak']),
            ':k_appraisal'    => self::validateEnum($data['khusus_analis_appraisal'] ?? '', ['Ya','Tidak']),
            ':kasus'          => self::validateEnum($data['pernah_kasus_hukum'] ?? 'Tidak', ['Ya','Tidak']) ?? 'Tidak',
            ':keluarga'       => self::validateEnum($data['hubungan_keluarga_pegawai'] ?? 'Tidak', ['Ya','Tidak']) ?? 'Tidak',
            ':keluarga_detail'=> $data['hubungan_keluarga_detail'] ?? null,
            ':slik'           => self::validateEnum($data['status_slik'] ?? '', ['Lancar','Tidak Lancar']),
            ':penyakit'       => self::validateEnum($data['riwayat_penyakit'] ?? '', ['Ya','Tidak']),
