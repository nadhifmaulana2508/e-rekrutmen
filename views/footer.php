<footer class="bg-slate-900 text-slate-300 pt-16 pb-8 mt-16">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div class="md:col-span-2">
            <a href="<?= BASE_URL ?>/home" class="flex items-center gap-3 mb-4">
                <div class="w-11 h-11 rounded-xl gradient-brand flex items-center justify-center text-white shadow-lg">
                    <i class="fa-solid fa-user-tie text-lg"></i>
                </div>
                <div>
                    <p class="font-extrabold text-white leading-none text-lg">Rekrutmen</p>
                    <p class="text-xs text-slate-400 font-medium">Career Platform</p>
                </div>
            </a>
            <p class="text-sm leading-relaxed text-slate-400 max-w-md">
                Platform rekrutmen digital untuk mempertemukan talenta terbaik dengan peluang karier yang menantang. Proses transparan, cepat, dan nyaman.
            </p>
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm">
                <li><a href="<?= BASE_URL ?>/home"     class="hover:text-white inline-flex items-center gap-2 transition"><i class="fa-solid fa-chevron-right text-[10px] text-brand-500"></i>Home</a></li>
                <li><a href="<?= BASE_URL ?>/lowongan" class="hover:text-white inline-flex items-center gap-2 transition"><i class="fa-solid fa-chevron-right text-[10px] text-brand-500"></i>Daftar Lowongan</a></li>
                <li><a href="<?= BASE_URL ?>/status"   class="hover:text-white inline-flex items-center gap-2 transition"><i class="fa-solid fa-chevron-right text-[10px] text-brand-500"></i>Cek Status Lamaran</a></li>
                <li><a href="<?= BASE_URL ?>/faq"      class="hover:text-white inline-flex items-center gap-2 transition"><i class="fa-solid fa-chevron-right text-[10px] text-brand-500"></i>FAQ</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm">
                ...
                <li class="flex items-start gap-3">
                    ...
                    <span>Jl. Kariernesia No.88,<br>Jakarta Selatan 12190</span>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 mt-12 pt-6 border-t border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-3">
        <p class="text-xs text-slate-500">&copy; <?= date('Y') ?> <span class="font-semibold text-slate-300">Rekrutmen Platform</span>. All Rights Reserved.</p>
        <p class="text-xs text-slate-500">Made with <i class="fa-solid fa-heart text-pink-500"></i> in Indonesia</p>
    </div>
</footer>
