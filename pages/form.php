...
<div>
    ...
    <select name="bersedia_seluruh_wilayah" class="input">
...
<div><label class="label">Pendidikan Terakhir <span class="text-rose-500">*</span></label>
    <select name="pendidikan_terakhir" class="input" id="sel-pend">
...
<div><label class="label">Nama Sekolah/Universitas <span class="text-rose-500">*</span></label><input type="text" name="nama_institusi" class="input"></div>
<div><label class="label">Jurusan <span class="text-rose-500">*</span></label><input type="text" name="jurusan" class="input"></div>
<div><label class="label">Tahun Masuk</label><input type="number" name="tahun_masuk" class="input" min="1990" max="2030"></div>
<div><label class="label">Tahun Lulus <span class="text-rose-500">*</span></label><input type="number" name="tahun_lulus" class="input" min="1990" max="2030"></div>
...
<div><label class="label">Pernah terlibat kasus hukum? <span class="text-rose-500">*</span></label>
    <select name="pernah_kasus_hukum" class="input"><option value="Tidak">Tidak</option><option value="Ya">Ya</option></select></div>
<div><label class="label">Hubungan keluarga dengan pegawai? <span class="text-rose-500">*</span></label>
    <select name="hubungan_keluarga_pegawai" class="input" id="sel-keluarga"><option value="Tidak">Tidak</option><option value="Ya">Ya</option></select></div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
<div><label class="label">Surat Lamaran <span class="text-rose-500">*</span></label><input type="file" name="dokumen_surat_lamaran" accept=".pdf,.jpg,.jpeg,.png" class="input file-input"></div>
<div><label class="label">CV / Daftar Riwayat Hidup <span class="text-rose-500">*</span></label><input type="file" name="dokumen_cv" accept=".pdf,.jpg,.jpeg,.png" class="input file-input"></div>
<div><label class="label">KTP <span class="text-rose-500">*</span></label><input type="file" name="dokumen_ktp" accept=".pdf,.jpg,.jpeg,.png" class="input file-input"></div>
...
<div><label class="label">Ijazah Terakhir <span class="text-rose-500">*</span></label><input type="file" name="dokumen_ijazah" accept=".pdf,.jpg,.jpeg,.png" class="input file-input"></div>
...
<div class="space-y-3 mb-6">
    <label class="flex items-start gap-3 p-3 bg-slate-50 rounded-xl cursor-pointer hover:bg-slate-100 transition">
        <input type="checkbox" name="pernyataan_data_benar" value="1" class="mt-1 accent-brand-600">
    ...
    <label class="flex items-start gap-3 p-3 bg-slate-50 rounded-xl cursor-pointer hover:bg-slate-100 transition">
        <input type="checkbox" name="pernyataan_ikut_proses" value="1" class="mt-1 accent-brand-600">
    ...
    <label class="flex items-start gap-3 p-3 bg-slate-50 rounded-xl cursor-pointer hover:bg-slate-100 transition">
        <input type="checkbox" name="pernyataan_setuju_data" value="1" class="mt-1 accent-brand-600">
