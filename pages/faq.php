<section class="py-16 bg-gray-50 min-h-[60vh]">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
        <div class="text-center mb-10">
            ...
            <p class="text-gray-600 mt-3">Jawaban cepat untuk pertanyaan yang sering diajukan kandidat.</p>
        </div>
        ...
        <div class="space-y-3" id="faq">
            ...
            $faqs = [
                ...
                ['Bagaimana jika lupa kode tracking?',              'Silakan hubungi tim HR melalui email <strong>hr@bprbkkjateng.co.id</strong> dengan menyertakan email yang kamu gunakan saat melamar.'],
            ];
            foreach ($faqs as $i => [$q, $a]): ?>
                <details class="group bg-white rounded-2xl border border-gray-100 hover:border-brand-200 transition overflow-hidden">
                    <summary class="flex items-center justify-between gap-3 p-5 cursor-pointer font-bold text-slate-900 hover:text-brand-700">
                        ...
                        <i class="fa-solid fa-chevron-down text-sm text-gray-400 transition-transform group-open:rotate-180"></i>
                    </summary>
                    <div class="px-5 pb-5 pl-16 text-gray-600 leading-relaxed"><?= $a ?></div>
                </details>
            <?php endforeach; ?>
        </div>

        <div class="mt-10 bg-white rounded-2xl p-6 border border-gray-100 text-center">
            <p class="text-gray-600">Masih punya pertanyaan lain?</p>
            <a href="mailto:hr@bprbkkjateng.co.id" class="mt-3 inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-brand-700 hover:bg-brand-800 text-white font-bold shadow-md hover:-translate-y-0.5 transition">
